...
export async function installMockSupabase(page,{role='student'}={}){
  ...
  await page.route('https://kvwsqfnyebyjncfgvqnd.supabase.co/**',async route=>{
    ...
    if(path==='/rest/v1/rpc/admin_certificate_roster')return json(route,[{certificate_id:IDS.certificate,user_id:IDS.user,student_name:'Aluno QA',email:'qa@lc.invalid',course_id:IDS.course,course_title:'Lógica de Programação Básica',verification_code:'LC-QA-2026',issued_at:'2026-08-28T12:00:00Z'}]);

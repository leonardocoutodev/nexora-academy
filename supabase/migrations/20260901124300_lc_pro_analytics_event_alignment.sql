-- Keep the production analytics RPC aligned with the LC Pro UI instrumentation.
-- Preserves public landing/support tracking, privacy guards and rate limiting.
